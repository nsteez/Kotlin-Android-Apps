...
class BestSellerBooksRecyclerViewAdapter(
    ...
    inner class BookViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        ...
        val mAmazonButton: Button = mView.findViewById<View>(id.buy_button) as Button
...
//
        ...
        //holder.mAmazonButton.text = book.amazonUrl.toString()


        holder.mAmazonButton.setOnClickListener{
